...
class GabutApp {
  ...
  /**
   * Get Profile
   * @params {integer} profileId - profileId of user (if empty default fill with own accountId)
  ...
  /**
   * Get Stream
   * @params {integer} itemId - curson of page (default 0)
  ...
  /**
   * Like Item
   * @params {integer} itemId - id of item to be liked
