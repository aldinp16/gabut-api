...
class GabutApp {
  constructor () {
    ...
    requestOptions.baseUrl = 'https://45.13.132.48/'
  ...
  async auth ({ username, password, clientId = 1005 }) {
    try {
      const response = await this.request
        .post('/api/v3-beta/method/account.signIn')
  ...
  getProfile (profileId = this.accountId) {
    return this.request('/api/v3-beta/method/profile.get', {
   ...
   */
  getStream (itemId = 0) {
    return this.request('/api/v3-beta/method/stream.get', {
      form: { itemId }
    })
  }
   ...
   */
  likeItem (itemId) {
    return this.request('/api/v3-beta/method/items.like', {
      form: { itemId }
    })
  }
   ...
   */
  removePost (itemId) {
    return this.request('/api/v3-beta/method/items.remove', {
      form: { itemId }
    })
  }
  ...
  getWall (profileId = this.accountId, cursor = 0) {
    return this.request('/api/v3-beta/method/wall.get', {
